...
include("config.php");
    if(isset($_POST['email']) && $_POST['password']){
        ...
        $sql=$conn->prepare("SELECT name FROM chatters WHERE email=? and password='$password'");
...
<form id="chat_login">
    ...
    <div class="inputGroup inputGroup1">
        ...
        <input type="text" id="email" class="email" autocomplete="off" maxlength="256" required placeholder="email@domain.com"/>
        <p class="helper helper1"></p>
        <span class="indicator"></span>
    </div>
    <div class="inputGroup inputGroup2">
        <label for="password">Password</label>
        <input type="password" id="password" autocomplete="off" required class="password"/>
    </div>
    <div class="inputGroup inputGroup3">
        <input type="submit" class="login_button" id="login" value="Login">
    </div>
</form>
